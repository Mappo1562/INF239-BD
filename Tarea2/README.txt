...
EJECUCIÓN
--------------------------------------------------------------------
Es necesario crear la carpeta INF239-BD en la siguiente direccion:
C:\xampp\htdocs. Para el correcto funcionamiento del programa es necesario 
tener instalado "xampp". Luego seleccionar el modulo "apache" y "mysql".
